Trabalho 1 : o objetivo do programa é criar um modelo com a finalidade de coletar informações estatísticas sobre textos, utilizando modelos de contexto finito.
